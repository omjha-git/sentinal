...
var gatewayEmbeddingWarningSchema = import_v48.z.discriminatedUnion("type", [
  import_v48.z.object({
...
var gatewayEmbeddingResponseSchema = (0, import_provider_utils8.lazySchema)(
  () => (0, import_provider_utils8.zodSchema)(
    import_v48.z.object({
      ...
      warnings: import_v48.z.array(gatewayEmbeddingWarningSchema).optional(),
...
var gatewayRerankingWarningSchema = import_v411.z.discriminatedUnion("type", [
  import_v411.z.object({
    type: import_v411.z.literal("unsupported"),
    feature: import_v411.z.string(),
    details: import_v411.z.string().optional()
  }),
  import_v411.z.object({
    type: import_v411.z.literal("compatibility"),
    feature: import_v411.z.string(),
    details: import_v411.z.string().optional()
  }),
  import_v411.z.object({
    type: import_v411.z.literal("other"),
    message: import_v411.z.string()
  })
]);
var gatewayRerankingResponseSchema = (0, import_provider_utils11.lazySchema)(
  () => (0, import_provider_utils11.zodSchema)(
    import_v411.z.object({
      ...
      warnings: import_v411.z.array(gatewayRerankingWarningSchema).optional(),
...
async function getVercelRequestId() {
  var _a11;
  return (_a11 = (0, import_oidc.getContext)().headers) == null ? void 0 : _a11["x-vercel-id"];
}
...
function createGatewayProvider(options = {}) {
  ...
  let lastFetchTime = 0;
  const baseURL = (_b11 = (0, import_provider_utils14.withoutTrailingSlash)(options.baseURL)) != null ? _b11 : "https://ai-gateway.vercel.sh/v3/ai";
