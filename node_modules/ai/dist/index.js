...
__export(src_exports, {
  AISDKError: () => import_provider22.AISDKError,
  APICallError: () => import_provider22.APICallError,
  ...
  EmptyResponseBodyError: () => import_provider22.EmptyResponseBodyError,
  Experimental_Agent: () => ToolLoopAgent,
  HttpChatTransport: () => HttpChatTransport,
  InvalidArgumentError: () => InvalidArgumentError,
  InvalidDataContentError: () => InvalidDataContentError,
  InvalidMessageRoleError: () => InvalidMessageRoleError,
  InvalidPromptError: () => import_provider22.InvalidPromptError,
  InvalidResponseDataError: () => import_provider22.InvalidResponseDataError,
  ...
  JSONParseError: () => import_provider22.JSONParseError,
  JsonToSseTransformStream: () => JsonToSseTransformStream,
  LoadAPIKeyError: () => import_provider22.LoadAPIKeyError,
  LoadSettingError: () => import_provider22.LoadSettingError,
  MessageConversionError: () => MessageConversionError,
  MissingToolResultsError: () => MissingToolResultsError,
  NoContentGeneratedError: () => import_provider22.NoContentGeneratedError,
  NoImageGeneratedError: () => NoImageGeneratedError,
  NoObjectGeneratedError: () => NoObjectGeneratedError,
  NoOutputGeneratedError: () => NoOutputGeneratedError,
  NoSpeechGeneratedError: () => NoSpeechGeneratedError,
  NoSuchModelError: () => import_provider22.NoSuchModelError,
  ...
  TooManyEmbeddingValuesForCallError: () => import_provider22.TooManyEmbeddingValuesForCallError,
  ToolCallNotFoundForApprovalError: () => ToolCallNotFoundForApprovalError,
  ToolCallRepairError: () => ToolCallRepairError,
  ToolLoopAgent: () => ToolLoopAgent,
  TypeValidationError: () => import_provider22.TypeValidationError,
  UIMessageStreamError: () => UIMessageStreamError,
  UI_MESSAGE_STREAM_HEADERS: () => UI_MESSAGE_STREAM_HEADERS,
  UnsupportedFunctionalityError: () => import_provider22.UnsupportedFunctionalityError,
  UnsupportedModelVersionError: () => UnsupportedModelVersionError,
  addToolInputExamplesMiddleware: () => addToolInputExamplesMiddleware,
  asSchema: () => import_provider_utils41.asSchema,
  ...
  createIdGenerator: () => import_provider_utils41.createIdGenerator,
  ...
  dynamicTool: () => import_provider_utils41.dynamicTool,
  embed: () => embed,
  embedMany: () => embedMany,
  ...
  generateId: () => import_provider_utils41.generateId,
  ...
  jsonSchema: () => import_provider_utils41.jsonSchema,
  ...
  parseJsonEventStream: () => import_provider_utils41.parseJsonEventStream,
  ...
  tool: () => import_provider_utils41.tool,
  ...
  zodSchema: () => import_provider_utils41.zodSchema
});
module.exports = __toCommonJS(src_exports);
var import_gateway4 = require("@ai-sdk/gateway");
var import_provider_utils41 = require("@ai-sdk/provider-utils");
...
var _a4;
var InvalidToolApprovalSignatureError = class extends import_provider4.AISDKError {
  constructor({
    approvalId,
    toolCallId,
    reason
...
var _a5;
var InvalidToolInputError = class extends import_provider5.AISDKError {
  constructor({
    toolInput,
    toolName,
    cause,
    message = `Invalid input for tool ${toolName}: ${(0, import_provider5.getErrorMessage)(cause)}`
  }) {
...
var _a6;
var ToolCallNotFoundForApprovalError = class extends import_provider6.AISDKError {
  constructor({
    toolCallId,
    approvalId
  }) {
...
var _a7;
var MissingToolResultsError = class extends import_provider7.AISDKError {
...
var _a8;
var NoImageGeneratedError = class extends import_provider8.AISDKError {
  constructor({
...
var _a10;
var NoOutputGeneratedError = class extends import_provider10.AISDKError {
  // used in isInstance
  constructor({
...
var _a11;
var NoSpeechGeneratedError = class extends import_provider11.AISDKError {
  constructor(options) {
    super({
      name: name11,
...
var _a12;
var NoTranscriptGeneratedError = class extends import_provider12.AISDKError {
  constructor(options) {
    super({
      name: name12,
...
var _a13;
var NoVideoGeneratedError = class extends import_provider13.AISDKError {
  constructor({
...
var ToolCallRepairError = class extends import_provider15.AISDKError {
  ...
  static isInstance(error) {
    return import_provider15.AISDKError.hasMarker(error, marker15);
  }
};
_a15 = symbol15;
...
var _a16;
var UIMessageStreamError = class extends import_provider17.AISDKError {
  constructor({
    chunkType,
    chunkId,
    message
...
var _a17;
var InvalidDataContentError = class extends import_provider18.AISDKError {
  constructor({
    content,
    cause,
...
var _a18;
var InvalidMessageRoleError = class extends import_provider19.AISDKError {
  constructor({
    role,
...
var _a20;
var RetryError = class extends import_provider21.AISDKError {
  constructor({
    message,
    reason,
    errors
  ...
  static isInstance(error) {
    return import_provider21.AISDKError.hasMarker(error, marker20);
  }
};
_a20 = symbol20;
...
function getGlobalProvider() {
  var _a22;
  return (_a22 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a22 : import_gateway.gateway;
}
...
async function createToolModelOutput({
  ...
  if (errorMode === "text") {
    return { type: "error-text", value: (0, import_provider24.getErrorMessage)(output) };
    ...
    switch (toolType) {
      ...
      case "function":
        languageModelTools.push({
          ...
          inputSchema: await (0, import_provider_utils6.asSchema)(tool2.inputSchema).jsonSchema,
...
async function standardizePrompt({
  ...
  if (prompt == null && messages == null) {
    throw new import_provider25.InvalidPromptError({
      prompt,
...
function wrapGatewayError(error) {
  ...
  if (isProductionEnv) {
    return new import_provider26.AISDKError({
      name: "GatewayError",
...
function getRetryDelayInMs({
  ...
  const headers = import_provider27.APICallError.isInstance(error) ? error.responseHeaders : import_provider27.APICallError.isInstance(error.cause) ? error.cause.responseHeaders : void 0;
  if (!headers)
...
function toBase64url(bytes) {
  return (0, import_provider_utils11.convertUint8ArrayToBase64)(bytes).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/g, "");
}
function fromBase64url(str) {
  return (0, import_provider_utils11.convertBase64ToUint8Array)(str);
}
...
async function validateApprovedToolApprovals({
  ...
  for (const approval of approvedToolApprovals) {
    ...
    if (tool2 != null && typeof tool2.execute === "function" && tool2.inputSchema != null) {
      const validation = await (0, import_provider_utils12.safeValidateTypes)({
        value: toolCall.input,
        schema: (0, import_provider_utils12.asSchema)(tool2.inputSchema)
      });
...
var object = ({
  ...
  const schema = (0, import_provider_utils14.asSchema)(inputSchema);
  return {
    name: "object",
    responseFormat: (0, import_provider_utils14.resolve)(schema.jsonSchema).then((jsonSchema2) => ({
      type: "json",
      schema: jsonSchema2,
    ...
    async parseCompleteOutput({ text: text2 }, context2) {
      const parseResult = await (0, import_provider_utils14.safeParseJSON)({ text: text2 });
...
var array = ({
  ...
  const elementSchema = (0, import_provider_utils14.asSchema)(inputElementSchema);
  return {
    name: "array",
    // JSON schema that describes an array of elements:
    responseFormat: (0, import_provider_utils14.resolve)(elementSchema.jsonSchema).then((jsonSchema2) => {
...
async function parseToolCall({
  ...
  try {
      ...
      try {
        repairedToolCall = await repairToolCall({
          ...
          inputSchema: async ({ toolName }) => {
            ...
            return await (0, import_provider_utils15.asSchema)(inputSchema).jsonSchema;
          },
          system,
          messages,
          error
    ...
    const parsedInput = await (0, import_provider_utils15.safeParseJSON)({ text: toolCall.input });
...
async function parseProviderExecutedDynamicToolCall(toolCall) {
  const parseResult = toolCall.input.trim() === "" ? { success: true, value: {} } : await (0, import_provider_utils15.safeParseJSON)({ text: toolCall.input });
...
async function doParseToolCall({
  ...
  const schema = (0, import_provider_utils15.asSchema)(tool2.inputSchema);
  const parseResult = toolCall.input.trim() === "" ? await (0, import_provider_utils15.safeValidateTypes)({ value: {}, schema }) : await (0, import_provider_utils15.safeParseJSON)({ text: toolCall.input, schema });
  if (parseResult.success === false) {
    throw new InvalidToolInputError({
      toolName,
      toolInput: toolCall.input,
...
// src/generate-text/generate-text.ts
var originalGenerateId = (0, import_provider_utils16.createIdGenerator)({
  prefix: "aitxt",
  size: 24
});
...
var toolMetadataSchema = import_v47.z.record(
  import_v47.z.string(),
  jsonValueSchema.optional()
);
var uiMessageChunkSchema = (0, import_provider_utils17.lazySchema)(
...
// src/generate-text/stream-text.ts
var originalGenerateId2 = (0, import_provider_utils20.createIdGenerator)({
  prefix: "aitxt",
  size: 24
});
...
var DefaultStreamTextResult = class {
  constructor({
    ...
    this._totalUsage = new import_provider_utils20.DelayedPromise();
    this._finishReason = new import_provider_utils20.DelayedPromise();
    this._rawFinishReason = new import_provider_utils20.DelayedPromise();
    this._steps = new import_provider_utils20.DelayedPromise();
      ...
      async pull(controller) {
        function abort() {
          ...
          controller.enqueue({
            ...
            ...(abortSignal == null ? void 0 : abortSignal.reason) !== void 0 ? { reason: (0, import_provider29.getErrorMessage)(abortSignal.reason) } : {}
          });
          controller.close();
        }
        try {
          ...
          if ((0, import_provider_utils20.isAbortError)(error) && (abortSignal == null ? void 0 : abortSignal.aborted)) {
            abort();
          } else {
            controller.error(error);
          }
...
var ToolLoopAgent = class {
  ...
  async prepareCall(options) {
    ...
    if (this.settings.callOptionsSchema != null && options.options !== void 0) {
      const validatedOptions = await (0, import_provider_utils21.validateTypes)({
...
function createUIMessageStream({
  ...
  onStepFinish,
  onFinish,
  generateId: generateId2 = import_provider_utils22.generateId
}) {
  let controller;
...
var toolMetadataSchema2 = import_v48.z.record(
  import_v48.z.string(),
  jsonValueSchema.optional()
);
var uiMessagesSchema = (0, import_provider_utils24.lazySchema)(
          ...
          import_v48.z.union([
            ...
            import_v48.z.object({
              ...
              approval: import_v48.z.object({
                ...
                signature: import_v48.z.string().optional()
              })
            }),
            import_v48.z.object({
              type: import_v48.z.literal("dynamic-tool"),
...
async function safeValidateUIMessages({
  ...
  try {
    ...
    const validatedMessages = await (0, import_provider_utils24.validateTypes)({
      value: messages,
...
function toImageModelV3File(dataContent) {
  ...
  if (typeof dataContent === "string" && dataContent.startsWith("data:")) {
    ...
    if (base64Content != null) {
      const uint8Data2 = (0, import_provider_utils27.convertBase64ToUint8Array)(base64Content);
      return {
        type: "file",
        data: uint8Data2,
...
var objectOutputStrategy = (schema) => ({
  ...
  async validateFinalResult(value) {
    return (0, import_provider_utils28.safeValidateTypes)({ value, schema });
  },
  createElementStream() {
    throw new import_provider31.UnsupportedFunctionalityError({
...
var arrayOutputStrategy = (schema) => {
  return {
    ...
    async validatePartialResult({
      ...
      var _a22;
      if (!(0, import_provider31.isJSONObject)(value) || !(0, import_provider31.isJSONArray)(value.elements)) {
        return {
          success: false,
      ...
      for (let i = 0; i < inputArray.length; i++) {
        ...
        const result = await (0, import_provider_utils28.safeValidateTypes)({ value: element, schema });
...
var enumOutputStrategy = (enumValues) => {
  return {
    ...
    async validateFinalResult(value) {
      if (!(0, import_provider31.isJSONObject)(value) || typeof value.result !== "string") {
        return {
          success: false,
          error: new import_provider31.TypeValidationError({
            value,
...
function getOutputStrategy({
  ...
  switch (output) {
    case "object":
      return objectOutputStrategy((0, import_provider_utils28.asSchema)(schema));
    case "array":
      return arrayOutputStrategy((0, import_provider_utils28.asSchema)(schema));
    case "enum":
...
async function parseAndValidateObjectResult(result, outputStrategy, context2) {
  const parseResult = await (0, import_provider_utils29.safeParseJSON)({ text: result });
  if (!parseResult.success) {
    throw new NoObjectGeneratedError({
      message: "No object generated: could not parse the response.",
      cause: parseResult.error,
...
async function parseAndValidateObjectResultWithRepair(result, outputStrategy, repairText, context2) {
  try {
    ...
    if (repairText != null && NoObjectGeneratedError.isInstance(error) && (import_provider32.JSONParseError.isInstance(error.cause) || import_provider32.TypeValidationError.isInstance(error.cause))) {
...
// src/generate-object/generate-object.ts
var originalGenerateId3 = (0, import_provider_utils30.createIdGenerator)({ prefix: "aiobj", size: 24 });
...
function simulateReadableStream({
  ...
  var _a22;
  const delay2 = (_a22 = _internal == null ? void 0 : _internal.delay) != null ? _a22 : import_provider_utils31.delay;
  let index = 0;
  return new ReadableStream({
    async pull(controller) {
...
var DefaultStreamObjectResult = class {
  constructor({
    ...
    this._object = new import_provider_utils32.DelayedPromise();
    this._usage = new import_provider_utils32.DelayedPromise();
    this._providerMetadata = new import_provider_utils32.DelayedPromise();
    this._warnings = new import_provider_utils32.DelayedPromise();
    this._request = new import_provider_utils32.DelayedPromise();
    this._response = new import_provider_utils32.DelayedPromise();
    this._finishReason = new import_provider_utils32.DelayedPromise();
    const model = resolveLanguageModel(modelArg);
    const { maxRetries, retry } = prepareRetries({
      maxRetries: maxRetriesArg,
      abortSignal
...
function smoothStream({
  delayInMs = 10,
  chunking = "word",
  _internal: { delay: delay2 = import_provider_utils34.delay } = {}
} = {}) {
  let detectChunk;
  if (chunking != null && typeof chunking === "object" && "segment" in chunking && typeof chunking.segment === "function") {
    ...
    if (chunkingRegex == null) {
      throw new import_provider33.InvalidArgumentError({
        argument: "chunking",
...
function customProvider({
  ...
  return {
    ...
    languageModel(modelId) {
      ...
      throw new import_provider34.NoSuchModelError({ modelId, modelType: "languageModel" });
    },
    embeddingModel(modelId) {
      ...
      throw new import_provider34.NoSuchModelError({ modelId, modelType: "embeddingModel" });
    },
    imageModel(modelId) {
    ...
    transcriptionModel(modelId) {
      ...
      throw new import_provider34.NoSuchModelError({ modelId, modelType: "transcriptionModel" });
    },
    speechModel(modelId) {
      ...
      throw new import_provider34.NoSuchModelError({ modelId, modelType: "speechModel" });
    },
    rerankingModel(modelId) {
      ...
      throw new import_provider34.NoSuchModelError({ modelId, modelType: "rerankingModel" });
    },
    videoModel(modelId) {
...
var _a21;
var NoSuchProviderError = class extends import_provider35.NoSuchModelError {
  constructor({
    modelId,
    modelType,
    providerId,
  ...
  static isInstance(error) {
    return import_provider35.AISDKError.hasMarker(error, marker21);
  }
};
_a21 = symbol21;
...
var DefaultProviderRegistry = class {
  ...
  splitId(id, modelType) {
    ...
    if (index === -1) {
      throw new import_provider36.NoSuchModelError({
        modelId: id,
        modelType,
  ...
  languageModel(id) {
    ...
    if (model == null) {
      throw new import_provider36.NoSuchModelError({ modelId: id, modelType: "languageModel" });
    }
  ...
  imageModel(id) {
    ...
    if (model == null) {
      throw new import_provider36.NoSuchModelError({ modelId: id, modelType: "imageModel" });
    }
  ...
  speechModel(id) {
    ...
    if (model == null) {
      throw new import_provider36.NoSuchModelError({ modelId: id, modelType: "speechModel" });
    }
    return model;
  }
  rerankingModel(id) {
    ...
    if (model == null) {
      throw new import_provider36.NoSuchModelError({ modelId: id, modelType: "rerankingModel" });
    }
    return model;
  }
};
...
async function transcribe({
  ...
  const headersWithUserAgent = (0, import_provider_utils36.withUserAgentSuffix)(
    headers != null ? headers : {},
    `ai/${VERSION}`
  );
...
async function callCompletionApi({
  ...
  try {
    ...
    const response = await fetch2(api, {
      ...
      credentials,
      headers: (0, import_provider_utils37.withUserAgentSuffix)(
        {
          "Content-Type": "application/json",
          ...headers
        },
        `ai-sdk/${VERSION}`,
        (0, import_provider_utils37.getRuntimeEnvironmentUserAgent)()
      ),
    ...
    switch (streamProtocol) {
      ...
      case "data": {
        await consumeStream({
          stream: (0, import_provider_utils37.parseJsonEventStream)({
            stream: response.body,
...
var HttpChatTransport = class {
  ...
  async sendMessages({
    ...
    const resolvedBody = await (0, import_provider_utils38.resolve)(this.body);
    const resolvedHeaders = await (0, import_provider_utils38.resolve)(this.headers);
    const resolvedCredentials = await (0, import_provider_utils38.resolve)(this.credentials);
    const baseHeaders = {
      ...(0, import_provider_utils38.normalizeHeaders)(resolvedHeaders),
      ...(0, import_provider_utils38.normalizeHeaders)(options.headers)
    };
    ...
    const headers = (preparedRequest == null ? void 0 : preparedRequest.headers) !== void 0 ? (0, import_provider_utils38.normalizeHeaders)(preparedRequest.headers) : baseHeaders;
...
var DefaultChatTransport = class extends HttpChatTransport {
  ...
  processResponseStream(stream) {
    return (0, import_provider_utils39.parseJsonEventStream)({
      stream,
      schema: uiMessageChunkSchema
    }).pipeThrough(
      new TransformStream({
...
var AbstractChat = class {
  constructor({
    generateId: generateId2 = import_provider_utils40.generateId,
    id = generateId2(),
