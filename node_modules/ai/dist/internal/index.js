      ...
      for (const part of message.content) {
        if (part.type === "image" || part.type === "file") {
          downloadableFiles.push({
            ...
            mediaType: (_a5 = part.mediaType) != null ? _a5 : part.type === "image" ? "image/*" : void 0
          });
        }
      }
    }
      ...
      if (item.type === "image-url") {
        ...
        if (downloadedFile) {
          return {
            ...
            mediaType: (_a5 = downloadedFile.mediaType) != null ? _a5 : "image/*",
...
function getRetryDelayInMs({
  ...
  const headers = import_provider7.APICallError.isInstance(error) ? error.responseHeaders : import_provider7.APICallError.isInstance(error.cause) ? error.cause.responseHeaders : void 0;
  if (!headers)
